...
sudo $RSYNC -a --no-o --no-g -i -x -h -S --delete /Users/Shared/Pictures /Volumes/mediafiles-backup/Users/Shared

sudo $RSYNC -a --no-o --no-g -i -x -h -S --delete /Users/Shared/Movies /Volumes/mediafiles-backup/Users/Shared

sudo $RSYNC -a --no-o --no-g -i -x -h -S --delete /Users/Shared/"Master Aperture 3 Library.aplibrary" /Volumes/mediafiles-backup/Users/Shared
